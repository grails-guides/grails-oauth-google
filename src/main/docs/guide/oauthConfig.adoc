...
<6> Open your `client_id.json` you downloaded while setting up Google and insert your `client_id` field as your key
<7> Open your `client_id.json` you downloaded while setting up Google and insert your `client_secret` as your secret
