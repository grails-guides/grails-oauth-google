 ...
 * Link to our logout controller to invalidate spring context
...
[source,html]
.grails-app/views/login/_loginWithGoogle.gsp
----
include::{sourceDir}/grails-app/views/login/_loginWithGoogle.gsp[]
----
